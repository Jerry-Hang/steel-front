...
| "敞篷浴缸"假象 | 侧窗玻璃 (0.03) 与烟黑侧带 (0.035) 同值，平光下整条侧带读成空洞 | 玻璃提至 (0.062,0.068,0.088)，烧毁感保留、窗带可辨 |

**修正 §20.4 定性**：座舱并非几何敞开（车身是闭合棱柱、车顶在），"全敞浴缸"是低对比度假象——预渲染审计的价值恰在于此：它把"看起来像什么"和"实际是什么"分开验证。
