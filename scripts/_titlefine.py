...
w, h = im.size
px = im.load()
# framebuffer 中标题在底部 (用户 y=480 -> 截图 y = 1600-480-56=1064)
# 精细 ASCII x 700-1900, y 1040-1140 step 2
def ascii_region(x0, y0, x1, y1, step=2):
    for y in range(y0, y1, step):
        ...
        for x in range(x0, x1, step):
            ...
            line += ch
        print(line)
print('--- y 1040-1160 x 700-1900 (title, framebuffer coords) ---')
ascii_region(700, 1040, 1900, 1160, 2)
