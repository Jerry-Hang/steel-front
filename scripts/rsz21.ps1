...
$b = [System.Drawing.Bitmap]::FromFile('D:\Rust\steel-front\screenshots\2-1.png')
$nw = 1600
...
$nb.Save('D:\Rust\steel-front\screenshots\2-1s.png', [System.Drawing.Imaging.ImageFormat]::Png)
