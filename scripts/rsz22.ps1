...
$b = [System.Drawing.Bitmap]::FromFile('D:\Rust\steel-front\screenshots\2-2.png')
$nw = 1600
...
$nb.Save('D:\Rust\steel-front\screenshots\2-2s.png', [System.Drawing.Imaging.ImageFormat]::Png)
