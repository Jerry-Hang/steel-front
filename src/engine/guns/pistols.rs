...
pub fn mp443() -> crate::engine::guns::GunMesh {
    ...
    let parts = vec![
        ...
        (tz(0.0, 0.025, 0.06), cylinder(0.013, 0.13, 18), dsteel),
        ...
        (tz(0.0, -0.004, -0.048), torus_arc(0.024, 0.007, 3.30, 6.13, 16, 8), black),
...
pub fn rsh12() -> crate::engine::guns::GunMesh {
    ...
    let parts = vec![
        ...
        (tz(0.0, 0.032, 0.13), cylinder(0.016, 0.17, 18), steel),
        ...
        (tz(0.0, 0.045, -0.075), cylinder(0.035, 0.05, 20), steel),
        ...
        (rx(0.019, -0.03, -0.103, 0.28), beveled_box(0.005, 0.078, 0.033, 0.002, 2), wood),
        (tz(0.0, -0.006, -0.055), torus_arc(0.028, 0.007, 3.30, 6.13, 16, 8), black),
...
pub fn m18() -> crate::engine::guns::GunMesh {
    ...
    let parts = vec![
        ...
        (tz(0.0, -0.004, -0.05), torus_arc(0.021, 0.006, 3.30, 6.13, 16, 8), black),
...
pub fn mk23() -> crate::engine::guns::GunMesh {
    ...
    let parts = vec![
        ...
        (tz(0.0, 0.028, 0.065), cylinder(0.0135, 0.15, 18), steel),
        ...
        (tz(0.0, -0.005, -0.05), torus_arc(0.026, 0.0075, 3.30, 6.13, 16, 8), black),
