...
pub fn sv98() -> GunMesh {
    ...
    let parts = vec![
        (t(0.0, 0.045, 0.345) * rz(), cylinder(0.020, 0.55, 20), DARK),
        (t(0.0, 0.045, 0.670) * rz(), frustum(0.034, 0.030, 0.10, 20, true), DARK),
        ...
        (t(0.0, 0.165, 0.020) * rz(), cylinder(0.024, 0.32, 24), BRIGHT),
        (t(0.0, 0.165, 0.185) * rz(), cylinder(0.034, 0.02, 24), DARK),
        (t(0.0, 0.165, 0.197) * rz(), cylinder(0.028, 0.006, 24), DEEP),
        (t(0.0, 0.165, -0.155) * rz(), cylinder(0.030, 0.03, 24), DARK),
...
pub fn m2010() -> GunMesh {
    let t = |x: f32, y: f32, z: f32| Mat4::from_translation(glam::vec3(x, y, z));
    let parts = vec![
        (t(0.0, 0.045, 0.355) * rz(), cylinder(0.020, 0.55, 20), BRIGHT),
        (t(0.0, 0.045, 0.685) * rz(), frustum(0.036, 0.028, 0.11, 20, true), DARK),
        ...
        (t(0.0, 0.170, 0.020) * rz(), cylinder(0.024, 0.34, 24), BRIGHT),
        (t(0.0, 0.170, 0.190) * rz(), cylinder(0.035, 0.022, 24), DARK),
        (t(0.0, 0.170, 0.202) * rz(), cylinder(0.028, 0.005, 24), DEEP),
        (t(0.0, 0.170, -0.165) * rz(), cylinder(0.031, 0.03, 24), DARK),
...
pub fn mrad() -> GunMesh {
    let t = |x: f32, y: f32, z: f32| Mat4::from_translation(glam::vec3(x, y, z));
    let parts = vec![
        (t(0.0, 0.045, 0.360) * rz(), cylinder(0.020, 0.56, 20), BRIGHT),
        (t(0.0, 0.045, 0.690) * rz(), frustum(0.037, 0.029, 0.10, 20, true), DARK),
        ...
        (t(0.0, 0.175, 0.020) * rz(), cylinder(0.024, 0.35, 24), BRIGHT),
        (t(0.0, 0.175, 0.195) * rz(), cylinder(0.036, 0.022, 24), DARK),
        (t(0.0, 0.175, 0.207) * rz(), cylinder(0.030, 0.005, 24), DEEP),
        (t(0.0, 0.175, -0.170) * rz(), cylinder(0.032, 0.03, 24), DARK),
